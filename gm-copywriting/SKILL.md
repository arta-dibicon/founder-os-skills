...
2. Wenn JA: Lade `_research/[topic-slug]/copy_context.md` + `personas.json` als Default-Kontext. Auch nützlich: `voice_of_customer.md` (verbatim Quotes als Headlines), `offer_brief.md` (Necessary Beliefs), `market_research.md` (Wettbewerber-Positioning).

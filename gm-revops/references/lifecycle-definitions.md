...
|--------|--------|------------|
| First contact attempt | [brand] 4 business hours | Alert to sales manager at 4 hours |
| Qualification decision | [brand] 48 hours | Auto-escalate at 48 hours |
| Meeting scheduled (if qualified) | [brand] 5 business days | Weekly pipeline review flag |

### SQL-to-Opportunity SLA

| Metric | Target | Escalation |
|--------|--------|------------|
| Discovery call completed | [brand] 3 business days of SQL | Alert to AE manager |
| Opportunity created | [brand] 5 business days of SQL | Pipeline review flag |

### Opportunity-to-Close SLA

| Metric | Target | Escalation |
|--------|--------|------------|
| Proposal delivered | [brand] 5 business days of demo | AE manager alert |
